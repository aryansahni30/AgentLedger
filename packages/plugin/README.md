...
[![license: MIT](https://img.shields.io/badge/license-MIT-green?style=flat-square)](https://github.com/aryansahni30/AgentLedger/blob/main/LICENSE)
[![node](https://img.shields.io/node/v/agentledger-plugin.svg?style=flat-square&logo=nodedotjs&logoColor=white)](https://github.com/aryansahni30/AgentLedger/blob/main/package.json)
...
Source, CLI, and dashboard live in the [AgentLedger monorepo](https://github.com/aryansahni30/AgentLedger). Issues and PRs welcome; see [CONTRIBUTING.md](https://github.com/aryansahni30/AgentLedger/blob/main/CONTRIBUTING.md) and [SECURITY.md](https://github.com/aryansahni30/AgentLedger/blob/main/SECURITY.md).

## License

MIT. See [LICENSE](https://github.com/aryansahni30/AgentLedger/blob/main/LICENSE).
